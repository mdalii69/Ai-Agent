...
file_writer_tool_summary = FileWriterTool(file_name='summary.txt', directory='output')
file_writer_tool_action_items = FileWriterTool(file_name='action_items.txt', directory='output')
file_writer_tool_sentiment = FileWriterTool(file_name='sentiment.txt', directory='output')
